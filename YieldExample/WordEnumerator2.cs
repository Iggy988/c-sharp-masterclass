...
public class WordEnumerator2 : IEnumerator<string>
{
    ...
    public WordEnumerator2(string[] words)
    {
        _words = words;
    }
    ...
    public string Current
    {
        get
        {
            ...
            catch (IndexOutOfRangeException ex)
            {
                ...
                throw new IndexOutOfRangeException($"{nameof(CustomCollectionWithIteretors)}'s end reached. ", ex);
            }
